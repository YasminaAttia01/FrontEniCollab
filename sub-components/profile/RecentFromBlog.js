        ...
        <Card.Body>
          <div className="d-flex justify-content-between mb-5 align-items-center">
            ...
            <div className="d-flex align-items-center">
              ...
              <div className="ms-3">
                <h5 className="mb-0 fw-bold">Khadija</h5>
          ...
          <div className="mb-4">
            {/* text */}
            <p className="mb-4">Your project aims to develop a web application for managing academic projects to facilitate collaboration and coordination between students and teachers at ENICarthage school. The objective is to create a user-friendly and innovative platform that simplifies the planning, execution, and evaluation of academic projects, while also promoting effective tracking and communication among team members and supervisors.</p>
            <Image src="/images/blog/blog-img-8.jpg" className="rounded-3 w-100" alt="" />
          </div>
          {/* icons */}
          <div className="mb-4">
          ...
          <Row>
            <Col xl={1} lg={2} md={2} xs={12} className="mb-3 mb-lg-0">
              <Image src="/images/avatar/avatar-15.jpg" className="avatar avatar-md rounded-circle" alt="" />
            </Col>
